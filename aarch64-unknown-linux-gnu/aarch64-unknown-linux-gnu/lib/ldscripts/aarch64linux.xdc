...
OUTPUT_ARCH(aarch64)
ENTRY(_start)
SEARCH_DIR("=/home/matej/x-tools/aarch64-unknown-linux-gnu/aarch64-unknown-linux-gnu/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/home/matej/x-tools/aarch64-unknown-linux-gnu/aarch64-unknown-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
