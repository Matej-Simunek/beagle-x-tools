...
enum opt_code
{
  ...
  OPT_mbionic = 1205,                        /* -mbionic */
  OPT_mbranch_cost_ = 1206,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1207,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1208,     /* -mcaller-super-interworking */
  OPT_mcmse = 1209,                          /* -mcmse */
  OPT_mcpu_ = 1210,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1211,            /* -mfix-cortex-m3-ldrd */
  ...
  OPT_minline_thumb1_jumptable = 1218,       /* -minline-thumb1-jumptable */
  OPT_mlittle_endian = 1219,                 /* -mlittle-endian */
  OPT_mlong_calls = 1220,                    /* -mlong-calls */
  OPT_mmusl = 1221,                          /* -mmusl */
  OPT_mneon_for_64bits = 1222,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1223,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1224,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1225,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1226,               /* -mprint-tune-info */
  OPT_mpure_code = 1227,                     /* -mpure-code */
  OPT_mrestrict_it = 1228,                   /* -mrestrict-it */
  OPT_msched_prolog = 1229,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1230,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1231,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1232, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1233,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1234,                         /* -mthumb */
  OPT_mthumb_interwork = 1235,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1236,                  /* -mtls-dialect= */
  OPT_mtp_ = 1237,                           /* -mtp= */
  OPT_mtpcs_frame = 1238,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1239,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1240,                         /* -mtune= */
  OPT_muclibc = 1241,                        /* -muclibc */
  OPT_munaligned_access = 1242,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1243,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1244,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1245,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1246,              /* -mword-relocations */
  OPT_n = 1247,                              /* -n */
  OPT_no_canonical_prefixes = 1248,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1249,              /* -no-integrated-cpp */
  OPT_no_pie = 1250,                         /* -no-pie */
  OPT_nocpp = 1251,                          /* -nocpp */
  OPT_nodefaultlibs = 1252,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1253,                   /* -nostartfiles */
  OPT_nostdinc = 1254,                       /* -nostdinc */
  OPT_nostdinc__ = 1255,                     /* -nostdinc++ */
  OPT_nostdlib = 1256,                       /* -nostdlib */
  OPT_o = 1257,                              /* -o */
  OPT_p = 1258,                              /* -p */
  OPT_pass_exit_codes = 1259,                /* -pass-exit-codes */
  /* OPT_pedantic = 1260, */                 /* -pedantic */
  OPT_pedantic_errors = 1261,                /* -pedantic-errors */
  OPT_pg = 1262,                             /* -pg */
  OPT_pie = 1263,                            /* -pie */
  OPT_pipe = 1264,                           /* -pipe */
  OPT_posix = 1265,                          /* -posix */
  ...
  OPT_profile = 1277,                        /* -profile */
  OPT_pthread = 1278,                        /* -pthread */
  OPT_quiet = 1279,                          /* -quiet */
  OPT_r = 1280,                              /* -r */
  OPT_rdynamic = 1281,                       /* -rdynamic */
  OPT_remap = 1282,                          /* -remap */
  OPT_s = 1283,                              /* -s */
  OPT_save_temps = 1284,                     /* -save-temps */
  OPT_save_temps_ = 1285,                    /* -save-temps= */
  OPT_shared = 1286,                         /* -shared */
  OPT_shared_libgcc = 1287,                  /* -shared-libgcc */
  ...
  OPT_static_libgfortran = 1293,             /* -static-libgfortran */
  OPT_static_libgo = 1294,                   /* -static-libgo */
  OPT_static_liblsan = 1295,                 /* -static-liblsan */
  OPT_static_libmpx = 1296,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1297,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1298,               /* -static-libstdc++ */
  OPT_static_libtsan = 1299,                 /* -static-libtsan */
  OPT_static_libubsan = 1300,                /* -static-libubsan */
  OPT_static_pie = 1301,                     /* -static-pie */
  /* OPT_std_c__03 = 1302, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1303, */                /* -std=c++0x */
  OPT_std_c__11 = 1304,                      /* -std=c++11 */
  OPT_std_c__14 = 1305,                      /* -std=c++14 */
  OPT_std_c__17 = 1306,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1307, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1308, */                /* -std=c++1z */
  OPT_std_c__2a = 1309,                      /* -std=c++2a */
  OPT_std_c__98 = 1310,                      /* -std=c++98 */
  OPT_std_c11 = 1311,                        /* -std=c11 */
  OPT_std_c17 = 1312,                        /* -std=c17 */
  /* OPT_std_c18 = 1313, */                  /* -std=c18 */
  ...
  OPT_std_f2018 = 1322,                      /* -std=f2018 */
  OPT_std_f95 = 1323,                        /* -std=f95 */
  OPT_std_gnu = 1324,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1325, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1326, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1327,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1328,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1329,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1330, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1331, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1332,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1333,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1334,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1335,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1336, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1337, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1338, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1339,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1340,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1341, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1342, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1343,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1344, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1345, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1346, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1347, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1348, */         /* -std=iso9899:2018 */
